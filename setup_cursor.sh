...
CONFIG_FILE3=~/Library/Application\ Support/Cursor/mcp_settings.json

# 确定使用哪个配置文件
CONFIG_FILE=""
if [ -d "~/Library/Application Support/Cursor/User/globalStorage" ]; then
    CONFIG_FILE="$CONFIG_FILE2"
    mkdir -p ~/Library/Application\ Support/Cursor/User/globalStorage
elif [ -d "~/Library/Application Support/Cursor" ]; then
...
echo -e "${GREEN}✓ Cursor MCP 配置已更新${NC}"
echo ""
